      ...
      <div className="footer-grid">
        <div>
          ...
          <div style={{ display: "flex", gap: "16px" }}>
           <a href="https://facebook.com/yourpage" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--cream)', textDecoration: 'none' }}>f</a>
<a href="https://instagram.com/yourhandle" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--cream)', textDecoration: 'none' }}>ig</a>
<a href="https://pinterest.com/yourhandle" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--cream)', textDecoration: 'none' }}>p</a>
          </div>
        </div>
